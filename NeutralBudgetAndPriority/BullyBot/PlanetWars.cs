...
public class PlanetWars
{
	...
	public int Distance(int sourcePlanet, int destinationPlanet)
	{
		...
		//optimization, I do not need the actual distance, the higher the number, the farther it is.
		return (int)Math.Ceiling(dx * dx + dy * dy);
	}
	...
	public void IssueOrder(int sourcePlanet,
						   ...
						   int numShips)
	{
		string mesage = "" + sourcePlanet + " " + destinationPlanet + " " +
				  numShips;
